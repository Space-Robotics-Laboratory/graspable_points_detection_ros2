...
#include <rclcpp/rclcpp.hpp> //was ros/ros.h
...
#include <sensor_msgs/msg/point_cloud.h> //#include <sensor_msgs/PointCloud.h>
#include <sensor_msgs/msg/point_cloud2.h> //#include <sensor_msgs/PointCloud2.h>
//#include <sensor_msgs/point_cloud_conversion.h>
#include <visualization_msgs/msg/marker.hpp> //#include <visualization_msgs/Marker.h>
#include <visualization_msgs/msg/marker_array.hpp> //#include <visualization_msgs/MarkerArray.hpp> 
#include <geometry_msgs/msg/pose.h>   //#include <geometry_msgs/Pose.h>
...
public:
	...
	detect_graspable_points(sensor_msgs::msg::PointCloud2 cloud_msg);
...
private:
	...
	vector<vector<vector<int>>> creategrippermask(GripperParam gripper_param, float voxel_size);
	/**
	...
	rclcpp::Node node =rclcpp::Node("graspable_not_main");
	rclcpp::Node timing_node =rclcpp::Node("timing_node");
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr downsampled_points_pub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("/down_sample_points", 1);
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr interpolate_point_pub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("/interpolated_point", 1);
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr peaksPub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("peaks_of_convex_surface", 1);
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr rainbowPub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("graspability_map", 1);
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr combinedPub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("graspable_points_after_combined_criterion", 1);
	rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr transformed_point_pub = node.create_publisher<sensor_msgs::msg::PointCloud2> ("transformed_point", 1);
	rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr point_visualization_marker_pub = node.create_publisher<visualization_msgs::msg::Marker> ("/detect_graspable_points/point_visualization_marker", 1);
	rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr marker_pub = node.create_publisher<visualization_msgs::msg::Marker> ("normal_vector", 1);
	tf2_ros::TransformBroadcaster dynamic_tf=tf2_ros::TransformBroadcaster(node);
};
